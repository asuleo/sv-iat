  ...
  var iatObj =
    {
      ...
      isTouch:false, //BUNU AYRICA DENE, TOUCHSCREEN DE OLUYOR.
      ...
      leftKeyText : 'Tryck på "E" för', 
      rightKeyText : 'Tryck på "I" för', 
      ...
      finalText : 'Tryck på blanksteg för att fortsätta till nästa uppgift', 
      ...
      // the name of the categories and the block's number variables:
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Sätt ett vänster finger på <b>E</b> knappen för objekt som tillhör kategorin <font color="#0000ff">leftAttribute.</font>' +
				'<br/>Sätt ett höger finger på  <b>I</b> knappen för objekt som tillhör kategorin <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				'Om du gör ett misstag, en röd <font color="#ff0000"><b>X</b></font> visas. ' +
				'Tryck på den andra knappen för att fortsätta.<br/>' +
				'<u>Gå så fort du kan</u> samtidigt som den är noggrann.<br/><br/></p>'+
				'<p align="center">Tryck på <b>mellanslag</b> när du är redo att börja.</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Sätt ett vänsterfinger över<b>vänster</b> grönt område for föremål som tillhör kategorin <font color="#0000ff">leftAttribute</font>.<br/>',
						'Sätt ett högerfinger över <b>höger</b> grönt område for iföremål som tillhör kategorin <font color="#0000ff">rightAttribute</font>.<br/>',
						'Objekten kommer att dyka upp ett i taget.<br/>',
						'<br/>',
						'Om du gör ett misstag, en röd <font color="#ff0000"><b>X</b></font> visas. Tryck på andra sidan. <u>Gå så fort du kan </u> samtidigt som du är noggrann.',
					'</p>',
      ...
      manyErrors: 'Det gjordes för många fel för att fastställa ett resultat.',
      tooFast: 'Det var för många snabba försök för att fastställa ett resultat.',
      notEnough: 'Det fanns inte tillräckligt med försök för att fastställa ett resultat.'
    };
